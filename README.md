...
(`Infor LN Extensions Development Guide 108 (01062026).pdf`,
`Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud) 11082026.pdf`,
`U8627B US - Infor Integration 6.2 - Developer_s Guide for Application Function Server.pdf`)
ให้เป็น Markdown ล้วน เพื่อให้ agent ค้นหาและอ่านได้โดยตรง

- **2,906 + 155 + 162 + 2,332 + 76 หน้า** | **2,366 function references** | **17 บท extensions** | **1,805 public interfaces** | **AFS `stpapi.*` ครบทุก primitive** | ค้นหาด้วย `scripts/search.py`
...
└── references/
    ...
    ├── PUBLIC_INTERFACES_INDEX.md # index public interfaces ทั้งหมดแยกตาม chapter
    ├── AFS_INDEX.md             # index stpapi.* primitives พร้อม signature
    ├── extensions/...           # Infor LN Extensions Development Guide (17 chapters)
    ├── public_interfaces/...    # Public Interfaces & Process Extensions (1,805 ฟังก์ชัน)
    ├── afs/...                  # AFS Developer's Guide (8 chapters/appendices)
