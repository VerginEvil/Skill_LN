...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 537-538
...
Usage:        Expl:   This Public Interface starts the session ATP Handling
(cprrp4800m000).
Pre:                  -
Post:                 -
Input:  iStartMode
...
## Public Interfaces for ItemMasterPlan

The following functions are available: ItemMasterPlan.Generate ItemMasterPlan.GenerateDemandPlan ItemMasterPlan.GenerateInventoryPlan ItemMasterPlan.StartPlan ItemMasterPlan.Update
