...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1462-1464
...
Usage:        Expl:   This function handles the printing of a Quote Documents for
the given Quote.
Closing of reports:
During quote documents printing, one or more reports may be
...
documents is printed or if text fields are printed.
...
LinesType                       domain tsepp.koql       5 (All Lines)
5 = All Lines
...
Output: oQuoteDocumentsPrinted                - True: the quote documents have been
printed.
False: the quote documents are not
printed.
...
not mean the documents have been printed.
<> 0                                          - An error occurred, but the documents
