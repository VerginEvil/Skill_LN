...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1601-1601

```baan
DLL:   ciextsliapi
This function is available from     2024.07 (KB3507528  ).
Syntax: long Installment.CreateCorrections(
...
Usage:        Expl:   This public interface is used to create corrections for billable
installment lines of the given order.
