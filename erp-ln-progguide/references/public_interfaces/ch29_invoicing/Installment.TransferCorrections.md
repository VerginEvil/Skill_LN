...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1604-1605

```baan
DLL:   ciextsliapi
This function is available from     2024.07 (KB3507555  ).
Syntax: long Installment.TransferCorrections(
...
Usage:        Expl:   This public interface is used to transfer the corrections of
...
information.
Return: 0                                     - Corrections transferred.
<> 0                                          - Error
```

## Public Interfaces for InvoicingBatch

The following functions are available: InvoicingBatch.CreateInvoice
