...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1600-1601

```baan
DLL:   ciextsliapi
This function is available from     2026.05 (KB3660942  ).
Syntax: long Installment.Close(
...
Usage:        Expl:   This public interface is used to close the installment of the
given order.
...
information.
Return: 0                                     - Installment Closed successfully.
<> 0                                          - Error
```
