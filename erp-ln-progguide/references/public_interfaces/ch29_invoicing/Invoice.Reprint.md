...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1609-1611

```baan
DLL:   ciextsliapi
This function is available from 2024.04 (KB2328014).
Syntax: long Invoice.Reprint(
...
domain  tcyesno          iCreateXMLInvoiceOnly,
...
use:    Invoice.ReprintV2
This function is used to reprint the invoice for the given
...
iCreateXMLInvoiceOnly   - Create XML Invoice Only
