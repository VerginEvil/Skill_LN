...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1622-1623
...
Usage:        Expl:   This Public Interface is used to transfer an approved
Installment Line to Invoicing. Before the transfer, the
Public Interface checks whether Installment Transfer is allowed
for the Installment Line.
