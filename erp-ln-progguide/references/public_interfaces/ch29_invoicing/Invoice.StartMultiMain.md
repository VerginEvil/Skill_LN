...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1596-1597
...
## Public Interfaces for ProformaInvoice

The following functions are available: ProformaInvoice.CancelInvoice ProformaInvoice.StartWorkbench
