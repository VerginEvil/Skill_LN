...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1960-1961
...
- The download action can only handle additional files in package tx
