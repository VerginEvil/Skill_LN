...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 132-133

```baan
DLL:   tcextcomapi
This function is available from     2021.03 (KB2172165  ).
Syntax: long BusinessPartner.StartOverview(
long             iStartMode,
...
domain  tccom.bpid       iParentBusinessPartner,
domain  tccom.cadr       iAddress,
ref     domain  tccom.bpid       oBusinessPartner,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This function starts session Business Partners -
(tccom4500m000).
Input:  iStartMode
...
iBusinessPartner                              - Business Partner      Not Mandatory
iSearchKey                                    - Search Key            Not Mandatory
iParentBusinessPartner                        - Parent BP             Not Mandatory
iAddress                                      - Address               Not Mandatory
Output: for iStartMode MODAL:
oBusinessPartner                              - Selected Business Partner
...
## Public Interfaces for BuyFromBusinessPartner

The following functions are available: BuyFromBusinessPartner.StartOverview
