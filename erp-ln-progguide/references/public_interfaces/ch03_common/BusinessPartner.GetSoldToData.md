...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 129-130

```baan
DLL:   tcextcomapi
This function is available from 2021.12 (KB2201372).
Syntax: long BusinessPartner.GetSoldToData(
...
... )
Usage:        Expl:   This function retrieves data from Sold-to Business Partners.
...
and the field value.
Example:
if BusinessPartner.GetSoldToData(
|* Fixed arguments:
575,                            --> input
"RLX000002",                    --> input
"",                             --> input
...
|* Variable arguments:
"cadr",                         --> input
l.tccom110.cadr,                --> output
"ccnt",                         --> input
l.tccom110.ccnt) <> 0 then      --> output
|* Error, do something
