...
Syntax: long BusinessPartner.GetBuyFromData(
...
... )
Usage:        Expl:   This function retrieves data from Buy-from Business Partners.
...
and the field value.
Example:
if BusinessPartner.GetBuyFromData(
|* Fixed arguments:
575,                            --> input
"RLX000002",                    --> input
"",                             --> input
...
|* Variable arguments:
"cadr",                         --> input
l.tccom120.cadr,                --> output
"ccnt",                         --> input
l.tccom120.ccnt) <> 0 then      --> output
|* Error, do something
