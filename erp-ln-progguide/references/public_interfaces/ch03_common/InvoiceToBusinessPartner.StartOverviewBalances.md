...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 137-138
...
## Public Interfaces for HoldReason

The following functions are available: HoldReasons.StartOverview
