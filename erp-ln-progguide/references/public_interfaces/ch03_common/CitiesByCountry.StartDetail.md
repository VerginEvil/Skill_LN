...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 142-143
...
## Public Interfaces for Task

The following functions are available: Task.StartMultiMain
