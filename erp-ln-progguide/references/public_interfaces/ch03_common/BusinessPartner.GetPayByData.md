...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 123-124

```baan
DLL:   tcextcomapi
This function is available from     2021.12 (KB2201372  ).
Syntax: long BusinessPartner.GetPayByData(
...
... )
Usage:        Expl:   This function retrieves data from Pay-by Business Partners.
...
and the field value.
Example:
if BusinessPartner.GetPayByData(
|* Fixed arguments:
575,                                                            --              > input
"RLX000002",                                                            --      > input
"",                                                            --               > input
...
|* Variable arguments:
"cadr",                                                            --           > input
l.tccom114.cadr,                                                            --  > output
"ccnt",                                                            --           > input
l.tccom114.ccnt) <> 0 then                                                    --> output
|* Error, do something
...
-                                               Pay-by Business Partner (mandatory)
