...
Syntax: long BusinessPartner.GetInvoiceToData(
...
... )
Usage:        Expl:   This function retrieves data from Invoice-to Business Partners.
...
and the field value.
Example:
if BusinessPartner.GetInvoiceToData(
|* Fixed arguments:
575,                            --> input
"RLX000002",                    --> input
"",                             --> input
...
|* Variable arguments:
"cadr",                         --> input
l.tccom112.cadr,                --> output
"ccnt",                         --> input
l.tccom112.ccnt) <> 0 then      --> output
|* Error, do something
