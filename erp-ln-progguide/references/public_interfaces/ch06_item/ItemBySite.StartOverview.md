...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 192-193
...
## Public Interfaces for ItemBySiteAndOffice

The following functions are available: ItemBySiteAndOffice.StartCreate
