...
Syntax: long PlanItem.CopySourcingStrategies(
...
Usage:        Expl:   Copy the Plan Item's Sourcing Strategies for the Planning
...
(mandatory).
iReferenceDate          Copy sourcing strategies effective on
...
information.
Return: 0                       The Plan Item's Sourcing Strategies were
succesfully copied.
<> 0                    Errors occurred.
```
