...
Usage:        Expl:   Use this function to cost a Rental Order (tssoc200).
See functionality in the costing session (tssoc2290m000) when
the Selection Criteria Level is set to Order.
...
information.
If setting the Rental Order to Costed does not succeed
...
MaximumLimitForOtherAmount (Goodwill Amount) are
expressed.
MaximumLimitForInvoiceAmount
domain  tcamnt          99999.0
The maximum net invoice amount of the Rental Order
