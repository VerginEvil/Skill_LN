...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 496-498

```baan
DLL:   tdextpcgapi
This function is available from     2020.03 (KB2111387  ).
Syntax: long Pricing.GetSalesSettings(
...
... )
Usage:        Expl:   This function retrieves sales pricing settings.
...
(settings table tdpcg081) depending on the specified input
...
Example: when attribute set for sales price and default sales
price book are needed, the function must be called as follows:
if Pricing.GetSalesSettings(
|* Fixed arguments:
company,                                                --> input
sales office,                                           --> input
site,                                                   --> input
...
|* Variable arguments:
"assp",                                               --> input
attribute.set.for.sales.price,                                --> output
"sdpb",                                               --> input
default.sales.price.book) <> 0 then                               --> output
|* Error, do something
