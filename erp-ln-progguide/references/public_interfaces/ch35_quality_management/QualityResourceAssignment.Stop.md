...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1779-1780

```baan
DLL:   qmextptcapi
This function is available from     2024.04 (KB2328014  ).
Syntax: long QualityResourceAssignment.Stop(
...
Usage:        Expl:   This function performs the Stop action which updates the actual
completion date of the resource assignment for the given document
...
information.
Return: 0                                     - Actual completion date updated.
<> 0                                          - Error
```

## Public Interfaces for

## ConformanceDocumentationRegister

The following functions are available: ConformanceDocumentationRegister.StartMultiMain
