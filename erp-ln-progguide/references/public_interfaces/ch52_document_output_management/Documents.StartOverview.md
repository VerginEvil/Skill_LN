...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1939-1941
...
## Chapter 53 Public Interfaces for Application

## Development

## Public Interfaces for AdditionalFile

The following functions are available: AdditionalFile.Download AdditionalFile.Upload
