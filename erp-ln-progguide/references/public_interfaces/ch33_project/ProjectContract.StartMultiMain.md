...
Syntax: long ProjectContract.StartMultiMain(
long             iStartMode,
...
Usage:        Expl:   This function starts the Multi-Main session "Contract"
(tpctm1600m000).
Input:  iStartMode
...
## Public Interfaces for ProjectContractLines

The following functions are available: ProjectContractLines.StartOverview
