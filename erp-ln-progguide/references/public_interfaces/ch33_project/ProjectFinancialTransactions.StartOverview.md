...
domain  tcttyp           iTransactionType,
domain  tcgld.docn       iInvoiceDocument,
...
Financial Transactions(tpppc2100m100) in overview mode.
Input:  iStartMode
...
"byToBeInvoiced"
data is displayed by documents to be invoiced
