...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1664-1664
...
Usage:        Expl:   This function executes the OnSync method of a protected noun
of the chameleon BOD and can only be called from the
OnExecuteHook of the OnSync method of an incoming public noun.
The function is used to route an incoming BOD with Sync verb to
a protected noun.
Pre:    NA
Post:   NA
Input:  iProtectedNoun  - The (protected) Noun for which the OnSync
