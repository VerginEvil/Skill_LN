...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1643-1643

```baan
DLL:   tcextbodapi
Syntax: long BOD.ExecuteOnAcknowledgeForChameleon(
...
Usage:        Expl:   This function executes the OnAcknowledge method of a protected
...
<> 0                                          - Error occured while processing BOD.
```
