...
```baan
DLL:   tcextbodapi
Syntax: long BOD.ExecuteOnProcessForChameleon(
...
Usage:        Expl:   This function executes the OnProcess method of a protected noun
of the chameleon BOD and can only be called from the
OnExecuteHook of the OnProcess method of an incoming public
noun. The function is used to route an incoming BOD with Process
