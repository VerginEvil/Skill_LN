...
## Public Interfaces for SalesOrderChangeRequest

The following functions are available: SalesOrderChangeRequest.Approve SalesOrderChangeRequest.Cancel SalesOrderChangeRequest.Process
