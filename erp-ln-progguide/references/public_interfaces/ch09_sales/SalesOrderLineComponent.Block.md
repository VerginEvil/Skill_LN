...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 362-363

```baan
DLL:   tdextslsapi
This function is available from 2022.11 (KB2257724).
Syntax: long SalesOrderLineComponent.Block(
...
Usage:        Expl.:  This function can be used to block a sales order line component.
It behaves similar to the functionality provided through session
