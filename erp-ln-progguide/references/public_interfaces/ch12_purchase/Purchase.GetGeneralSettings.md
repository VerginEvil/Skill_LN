...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 401-403

```baan
DLL:   tdextpurapi
This function is available from 2020.03 (KB2111387).
Syntax: long Purchase.GetGeneralSettings(
...
... )
Usage:        Expl:   This function retrieves general settings for purchase. Individual
...
(settings table tdpur080) depending on the specified input
...
if Purchase.GetGeneralSettings(
|* Fixed arguments:
company,                  --> input
site,                     --> input
