...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 447-448

```baan
DLL:   tdextpurapi
This function is available from     2020.03 (KB2111387  ).
Syntax: long PurchaseOrder.StartIntakeWorkbench(
long             iStartMode,
...
Usage:        Expl:   This function starts the session Purchase Order Intake Workbench
(tdpur4601m200).
Input:  iStartMode
