...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 415-416

```baan
DLL:   tdextpurapi
This function is available from     2025.12 (KB3634332  ).
Syntax: long RequestForQuoteResponse.Reject(
...
Usage:        Expl.:  This function rejects a request for quotation response.
...
information
Return: 0                                     - The Request for Quote is rejected
<> 0                                          - An error occurred
```

## Public Interfaces for PurchaseRequisition

The following functions are available: PurchaseRequisition.ApproveApprovalRecord PurchaseRequisition.RejectApprovalRecord PurchaseRequisition.StartMultiMain PurchaseRequisition.Submit
