...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 404-406

```baan
DLL:   tdextpurapi
This function is available from 2020.03 (KB2111387).
Syntax: long Purchase.GetRequisitionSettings(
...
... )
Usage:        Expl:   This function retrieves settings for Purchase Requisitions.
...
(settings table tdpur082) depending on the specified input
...
if Purchase.GetPurchaseRequisitionSettings(
|* Fixed arguments:
company,                  --> input
site,                     --> input
...
|* Variable arguments:
ngpr.2",                  --> input
number.group.for.requisitions,   --> output
"sepr",                   --> input
series.for.requisitions) <> 0 then --> output
|* Error, do something
