...
Syntax: long PurchaseContractLineLogisticData.Deactivate(
...
Usage:        Expl.:  Function can be used to deactivate a purchase contract logistic
data record.
This function cannot be used if Change Requests are applicable
for the given purchase contract. Deactivation of a contract
...
information.
Return: 0                                     - Contract Logistic Data is deactivated
<> 0                                          - An error occurred
```

## Public Interfaces for PurchaseContractPrice

The following functions are available: PurchaseContractPrice.Activate PurchaseContractPrice.Deactivate
