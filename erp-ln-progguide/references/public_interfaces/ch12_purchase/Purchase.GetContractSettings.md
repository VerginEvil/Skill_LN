...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 400-401

```baan
DLL:   tdextpurapi
This function is available from 2020.03 (KB2111387).
Syntax: long Purchase.GetContractSettings(
...
... )
Usage:        Expl:   This function retrieves settings for Purchase Contracts
...
(settings table tdpur083) depending on the specified input
...
if Purchase.GetPurchaseContractSettings(
|* Fixed arguments:
company,                  --> input
site,                     --> input
...
|* Variable arguments:
"ngpc.3",                 --> input
number.group.for.contracts, --> output
"sepc",                   --> input
contract.series,          --> output
"rpcs.3",                 --> input
link.with.pcs.module) <> 0 then --> output
|* Error, do something
