...
Syntax: long PurchaseContractPrice.Activate(
...
Usage:        Expl.:  Function can be used to activate a purchase contract price line.
...
information.
Return: 0                       - Contract price line is activated
<> 0                    - An error occurred
```
