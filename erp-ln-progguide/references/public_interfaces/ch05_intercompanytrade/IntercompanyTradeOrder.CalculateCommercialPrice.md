...
Usage:        Expl:   This Public Interface calculates the commercial price for
...
(tcitr3200m700) and are not explained in further detail here.
...
UpdateChangedAgreedAmounts      domain tcyesno          tcyesno.no
...
ReportName must start with an "r", e.g. "rtcitr320011700"
When corresponding input parameters are filled, the selection range
fields (From/To) of the i.processing.option.set will be ignored.
