...
Usage:        Expl:   This public interface processes the MBC numbers and approve by
production.
It works similarly to the session Process MBC (tiedm3250m000)
Approve by Production options.
...
information.
Return: 0                       Approved MBC by production successfully.
<> 0                    Error Occurred.
```
