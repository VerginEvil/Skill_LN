...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 257-259

```baan
DLL:   tiextedmapi
This function is available from     2026.09 (KB3633088  ).
Syntax: long EngineeringBillOfMaterial.FinalizeMBC(
domain  tcorno           iMBCNumber,
long             iProcessingOptionSet,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This public interface processes the MBC numbers and finalize.
...
ProductionBOMUpdateMethod       domain tiedm.updm       tiedm.updm.previous.linked
CopyDocumentLinks               domain tcyesno          tcyesno.yes
AttachedDocuments               domain tcyesno          tcyesno.no
OverwriteItemDescriptionandSearchKeys
...
information.
Return: 0                       Finalized engineering data successfully.
<> 0                    Error Occurred.
```
