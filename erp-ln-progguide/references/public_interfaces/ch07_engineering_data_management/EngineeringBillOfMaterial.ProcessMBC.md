...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 262-263

```baan
DLL:   tiextedmapi
This function is available from 2026.09 (KB3633088).
Syntax: long EngineeringBillOfMaterial.ProcessMBC(
domain  tcorno           iMBCNumber,
long             iProcessingOptionSet,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This public interface processes the MBC numbers and engineering
BOM changes. It works similarly to the session Process MBC
(tiedm3250m000) with Process Options.
...
CreateLinksToDocuments          domain tcyesno          tcyesno.yes
ApproveNewRevisionByEngineering domain tcyesno          tcyesno.yes
...
information.
Return: 0                       Processed Engineering BOM changes
successfully.
<> 0                    Error Occurred.
```
