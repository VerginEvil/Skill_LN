...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1062-1063

```baan
DLL:   whextinhapi
This function is available from 2020.05 (KB2117931).
Syntax: long HandlingUnit.StartAutomaticInboundProcessing(
domain  whhuid           iHandlingUnit,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This public interface will start the processing of the next
automatic activity after the receipt line has been confirmed for
a handling unit.
This public interface will generate inbound advices when this
is the next automatic activity of the related inbound order line
and given handling unit. When there is already an advice present
for the Handling Unit which must be putaway, please use one of
...
2) Notify the handling unit for automatic processing
...
ret.val = HandlingUnit.StartAutomaticInboundProcessing(..)
db.retry.point()
...
an inbound advice for the given handling unit. This public
