...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1064-1066
...
## Public Interfaces for InboundOrderLineActivity

The following functions are available: InboundOrderLineActivity.Create InboundOrderLineActivity.ModifyAutomaticProcessing
