...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1010-1010

```baan
DLL:   whextwmdapi
This function is available from 2020.04 (KB2115522).
Syntax: long CompanyItemInventory.StartDetail(
long             iStartMode,
domain  tcitem           iItem,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This function starts the detail session Company - Item
