...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1165-1166

```baan
DLL:   whextinhapi
This function is available from 2020.05 (KB2117931).
Syntax: long Shipment.StartAutomaticOutboundProcessing(
domain  whinh.shpm       iShipment,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This public interface will perform the next automatic activity
of the given shipment.
...
2) Notify the shipment for automatic processing
...
ret.val = Shipment.StartAutomaticOutboundProcessing(..)
db.retry.point()
...
for the related shipment. This public interface will stop the
