...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 908-909

```baan
DLL:   whextinhapi
This function is available from 2020.03 (KB2111387).
Syntax: long AdjustmentOrder.StartDetail(
long             iStartMode,
domain  tcorno           iOrder,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This function starts the detail session Adjustment Orders
(whinh5100m000).
Input:  iStartMode
