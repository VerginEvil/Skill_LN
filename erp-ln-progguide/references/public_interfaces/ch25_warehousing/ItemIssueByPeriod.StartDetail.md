...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 929-929

```baan
DLL:   whextinrapi
This function is available from 2025.12 (KB3625698).
Syntax: long ItemIssueByPeriod.StartDetail(
long             iStartMode,
domain  tcitem           iItem,
domain  tcyrno           iYear,
...
Usage:        Expl:   This function starts the detail session Item Issue by Period
(whinr1520m000).
Input:  iStartMode
