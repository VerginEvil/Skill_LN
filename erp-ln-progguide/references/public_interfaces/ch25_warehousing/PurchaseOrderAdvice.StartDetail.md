...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1303-1303

```baan
DLL:   whextinaapi
This function is available from 2025.11 (KB3629540).
Syntax: long PurchaseOrderAdvice.StartDetail(
long             iStartMode,
domain  tcpdno           iOrderNumber,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This function starts the detail session Production Order Advice
(whina3110m000).
Input:  iStartMode
