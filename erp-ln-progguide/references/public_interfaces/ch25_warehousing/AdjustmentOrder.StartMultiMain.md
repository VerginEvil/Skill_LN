...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 899-900

```baan
DLL:   whextinhapi
This function is available from     2020.03 (KB2111387  ).
Syntax: long AdjustmentOrder.StartMultiMain(
long             iStartMode,
...
Adjustment Order (whinh5600m000).
Input:  iStartMode
