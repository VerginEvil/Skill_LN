...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 976-976

```baan
DLL:   whextwmdapi
This function is available from 2025.10 (KB3619637).
Syntax: long WarehouseItemRentalInventory.StartDetail(
long             iStartMode,
