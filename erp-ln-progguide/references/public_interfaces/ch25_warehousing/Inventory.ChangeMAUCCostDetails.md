...
boolean          iSetNewMAUC,
long             iNewMAUCNumberOfCostComponents,
ref     domain  tccpcp           iNewMAUCCostCompArray() fixed,
ref     domain  tccopr           iNewMAUCReportCurrencyArray(),
boolean          iSetNewMAUH,
long             iNewMAUHNumberOfCostComponents,
ref     domain  tccpcp           iNewMAUHCostCompArray() fixed,
ref     domain  tcphrs           iNewMAUHArray(),
...
selection on cost component level.
Arrays must only be filled for the cost components which need to
be changed.
...
iProject                        Optional
iReason                         Mandatory
iReportCurrency                 Mandatory when iSetNewMAUC is
True
iExchangeRateType               Mandatory
iUsageOfRates                   Mandatory
iSetNewMAUC                     Mandatory
iNewMAUCNumberOfCostComponents  Used when iSetNewMAUC is True
iNewMAUCCostCompArray()         Used when iSetNewMAUC is True
iNewMAUCReportCurrencyArray()   Used when iSetNewMAUC is True
iSetNewMAUH                     Mandatory
iNewMAUHNumberOfCostComponents  Used when iSetNewMAUH is True
iNewMAUHCostCompArray()         Used when iSetNewMAUH is True
iNewMAUHArray()                 Used when iSetNewMAUH is True
