...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 924-924

```baan
DLL:   whextinrapi
This function is available from 2020.03 (KB2111387).
Syntax: long ItemWarehouseInventoryTransaction.StartDetail(
long             iStartMode,
domain  tcitem           iItem,
...
Inventory Transactions (whinr1510s000).
Input:  iStartMode
