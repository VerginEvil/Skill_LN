...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1294-1295

```baan
DLL:   whextinhapi
This function is available from 2023.09 (KB2304612).
Syntax: long WarehouseOrderLine.ActivityIsApplicable(
...
ref             boolean          oActivityApplicable,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This Public Interface checks if an activity is applicable for
...
Output: oActivityApplicable - Activity Applicable Indicator
