...
2) Notify the outbound run for automatic processing
...
ret.val = OutboundRun.StartAutomaticOutboundProcessing(..)
db.retry.point()
...
for the related outbound run. This public interface will
