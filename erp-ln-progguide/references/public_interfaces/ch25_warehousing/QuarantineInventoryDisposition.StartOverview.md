...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1209-1212

```baan
DLL:   whextwmdapi
This function is available from     2022.02 (KB2226318  ).
Syntax: long QuarantineInventoryDisposition.StartOverview(
long             iStartMode,
...
domain  whinh.dorg       iDispositionOrigin,
domain  tcorno           iDispositionOrder,
domain  whinh.shpm       iReceipt,
domain  tcpono           iReceipt.line,
...
Disposition(whwmd2172m000) in Overview Mode.
Input:  iStartMode
...
Possible values are:
"byQuarantineId":
data is displayed by Quarantine ID and Disposition Line
...
"byDispositionOrder":
data is displayed by Disposition Order
session will be started on index 5
view fields: Disposition Origin
"byReceiptLine":
...
iWarehouse
Mandatory if iStartMode = MODELESS and
iSessionIndex = 2 (or iStartFilter = "byWarehouseLocation"
iStartFilter = "byItemWarehouseLocation")
iLocation
Optional
iItem
Mandatory if iStartMode = MODELESS and
iSessionIndex = 3 (or iStartFilter = "byItemWarehouseLocation")
iOrderOrigin
Mandatory if iStartMode = MODELESS and
...
iDispositionOrigin
Mandatory if iStartMode = MODELESS and
iSessionIndex = 5 (or iStartFilter = "byDispositionOrder")
iDispositionOrder
Optional
iReceipt
Optional
...
oDispositionLine                              - Disposition Line of the selected record
...
## QuarantineInventoryDispositionLine

The following functions are available: QuarantineInventoryDispositionLine.GenerateInboundAdvice QuarantineInventoryDispositionLine.Move QuarantineInventoryDispositionLine.Process QuarantineInventoryDispositionLine.ProcessV2 QuarantineInventoryDispositionLine.Split
