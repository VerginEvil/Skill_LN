...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 900-901
...
## Public Interfaces for AdjustmentOrderLine

The following functions are available: AdjustmentOrderLine.Process AdjustmentOrderLine.Submit
