...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 963-964
...
## Public Interfaces for SiteItemInventory

The following functions are available: SiteItemInventory.StartDetail SiteItemInventory.StartOverview
