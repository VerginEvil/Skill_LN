...
Syntax: long Attendance.GetAttendanceTypeAbsence(
ref     domain  bpxtm.atty       oAttendanceTypeAbsence,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This function returns attendance type Absence
for the employee group which is under review.
Pre:
Post:
Input:
Output:
oAttendanceTypeAbsence                        - Attendance type Absence
