...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1828-1829

```baan
DLL:   pdextpdmapi
This function is available from     2024.10 (KB3532922  ).
Syntax: long PLMObject.CreateGenerationBulk(
domain  tcguid.extend    iBatchGuid,
ref     domain  tcmcs.s999m      oExceptionMessage mb,
ref             long             oExceptionID )
Usage:        Expl:   This Public Interface is to perform create generation for bulk
objects.
The transaction management has to be taken care by the calling
program.
All the parameters are mandatory.
Pre:    A list of objects for which generation needs to be created, by
...
specify the desired change mode for that object.
