...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2134-2134

```baan
Skips Price Book Line when global updating Prices via Price Books.
This process extension is available from 2023.04 (KB2272981).
