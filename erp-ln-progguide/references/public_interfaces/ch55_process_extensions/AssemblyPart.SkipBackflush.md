...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1951-1952

Skips backflushing of Assembly Parts. This process extension is available from 2022.12 ( KB2267502 ). Technical information for this process extension:
...
## Process Extensions for BankStatement

The following process extension(s) is/are available: BankStatement.CustomMatchOnExternalInvoice
