...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1976-1977

```baan
Skips Blocked Sales Order or Sales Order Line when executing Form Command 'Firm Release'.
