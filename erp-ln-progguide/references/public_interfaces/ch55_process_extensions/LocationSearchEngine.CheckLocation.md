...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2102-2102

```baan
Allows to skip or replace a location advised by standard LN search engine.
This process extension is available from 2025.04 (KB3563599).
