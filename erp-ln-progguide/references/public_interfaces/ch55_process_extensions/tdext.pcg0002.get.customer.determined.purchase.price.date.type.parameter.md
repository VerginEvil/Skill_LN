# tdext.pcg0002.get.customer.determined.purchase.price.date.type.parameter

> Chapter: Chapter 55 Process Extensions
>
> Group: Process Extensions for Pricing
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2112-2113

```baan
Syntax: long tdext.pcg0002.get.customer.determined.purchase.price.date.type.parameter(
...
from an extension for purchase parameter. This price date type will
