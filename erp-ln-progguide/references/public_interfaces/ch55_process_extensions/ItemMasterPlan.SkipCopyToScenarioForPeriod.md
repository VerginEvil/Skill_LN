...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2094-2095

```baan
Skips copying Item Master Plan to Scenario for specific Period.
This process extension is available from 2023.06 (KB2274036).
