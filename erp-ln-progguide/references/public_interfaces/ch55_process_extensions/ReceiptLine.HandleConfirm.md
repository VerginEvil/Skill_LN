...
```baan
Allows to manipulate the receipt line before or after confirmation.
This process extension is available from 2026.06 (KB3674048).
Technical information for this process extension:
Usage:        With this Process Extension it is possible to manipulate the receipt
line during confirmation.
