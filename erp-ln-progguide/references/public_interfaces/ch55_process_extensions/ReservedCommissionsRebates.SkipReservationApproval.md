...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2205-2206

Skips Reserved Commissions/Rebates when Reserving and Approving. This process extension is available from 2025.09 ( KB3598645 ). To implement this process extension, you can use the information below:
...
## Process Extensions for Sales

The following process extension(s) is/are available: Sales.AdditionalCostAmountCalculationSkipLine Sales.DetermineAdditionalCostSet Sales.SkipRetroBilledAdviceLineGeneration
