...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2107-2108

Skips transfer of Planned Orders. This process extension is available from 2022.12 ( KB2236258 ). Technical information for this process extension:
...
## Process Extensions for PlannedPRPOrder

The following process extension(s) is/are available: PlannedPRPOrder.SkipGenerate
