...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1967-1968

```baan
Skip Advance Installment during Z5 reporting.
This process extension is available from 2026.03 (KB3655880).
