...
```baan
Customize the logic with regards to combining new purchase order lines to existing purchase orders.
This process extension is available from 2024.04 (KB2326972).
