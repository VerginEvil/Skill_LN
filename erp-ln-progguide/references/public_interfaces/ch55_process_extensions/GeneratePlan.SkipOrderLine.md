...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2028-2028

Allows to skip Freight Order line from generating a freight plan. This process extension is available from 2025.06 ( KB3565345 ). To implement this process extension, you can use the information below:
...
## Process Extensions for GLTransaction

The following process extension(s) is/are available: GLTransaction.SkipPrintStandardAuditFileTax
