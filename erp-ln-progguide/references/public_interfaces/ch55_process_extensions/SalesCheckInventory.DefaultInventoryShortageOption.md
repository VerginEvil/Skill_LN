...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2238-2238

```baan
Determine customer specific default 'Automatic Inventory Shortage Option' for Sales Check
Inventory.
