...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1968-1969

```baan
Skips Assembly Orders when deleting.
This process extension is available from 2022.11 (KB2230993).
