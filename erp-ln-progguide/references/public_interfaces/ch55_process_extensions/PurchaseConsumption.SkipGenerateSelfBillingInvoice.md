...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2189-2190

```baan
Skip purchase consumption when generating self-billing purchase invoices.
