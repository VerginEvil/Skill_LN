...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2310-2311

```baan
Define a custom sorting for transfer of Planned Orders.
This process extension is available from 2024.06 (KB2328644).
