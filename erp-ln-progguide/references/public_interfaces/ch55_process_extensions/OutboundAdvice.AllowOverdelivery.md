...
```baan
Allows overdelivery for internal orders during outbound advice generation.
This process extension is available from 2026.07 (KB3674602).
Technical information for this process extension:
Usage:        With this Process Extension it is possible to allow overdelivery for
