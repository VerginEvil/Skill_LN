...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1955-1956

Skip Billable Line when composing. This process extension is available from 2024.09 ( KB3520951 ). To implement this process extension, you can use the information below:
...
## Process Extensions for BillOfLading

The following process extension(s) is/are available: BillOfLading.SkipShipmentLine
