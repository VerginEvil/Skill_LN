...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2209-2210

```baan
Skips Purchase Order Line when Printing Purchase Invoices.
This process extension is available from 2020.08 (KB2142810).
