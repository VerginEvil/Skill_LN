...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2248-2249

Skips Shipment Lines during Freeze/Confirm. This process extension is available from 2026.09 ( KB3690493 ). Technical information for this process extension:
...
## Process Extensions for StandardCost

The following process extension(s) is/are available: StandardCost.SkipActualize StandardCost.SkipCalculate StandardCost.UseAlternativeScheme
