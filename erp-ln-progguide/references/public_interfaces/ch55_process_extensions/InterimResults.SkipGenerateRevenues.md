...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2039-2040

Skips Generation of Revenues for Interim Results. This process extension is available from 2026.03 ( KB3635960 ). To implement this process extension, you can use the information below:
...
The following process extension(s) is/are available: IntrastatTransaction.CheckBlockedForReporting
