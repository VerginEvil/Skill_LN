...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2259-2260

```baan
Skips Sales Order Line when Generating Project Structure.
This process extension is available from 2025.01 (KB3546324).
