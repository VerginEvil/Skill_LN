...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2306-2306

```baan
Get content for an XML Text Tag for the Tax Declaration.
This process extension is available from 2025.08 (KB3572604).
