...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2286-2288

```baan
Skips Purchase Order Lines when Calculating Target Prices.
This process extension is available from 2024.12 (KB3540096).
