...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2269-2269

```baan
Allows to perform additional shipment building constraints during shipment building.
