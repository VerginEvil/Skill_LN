# tdext.pcg0002.get.customer.determined.service.price.date.type.setting

> Chapter: Chapter 55 Process Extensions
>
> Group: Process Extensions for Pricing
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2139-2139

```baan
Syntax: long tdext.pcg0002.get.customer.determined.service.price.date.type.setting(
domain  tdpur.pric       i.service.price.date.type.from.standard.logic,
domain  tcncmp           i.logistic.company,
domain  tccwoc           i.service.office,
ref     domain  tdpur.pric       o.service.price.date.type.from.extension )
Usage:        Expl:   Use this method to get a customer determined service price date type
from an extension for service office setting. This price date type
...
Note: The service office can be used to determine the price date type.
...
i.service.office                                - Service office
