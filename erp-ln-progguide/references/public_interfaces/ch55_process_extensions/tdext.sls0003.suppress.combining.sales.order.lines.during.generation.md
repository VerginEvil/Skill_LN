...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2231-2233
...
## Process Extensions for SalesOrderInvoiceLine

The following process extension(s) is/are available: SalesOrderInvoiceLine.SkipReleaseToInvoicing
