...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2198-2199

Skip Print Receivable Invoice Specification. This process extension is available from 2024.07 ( KB2329986 ). To implement this process extension, you can use the information below:
...
## ReceivedCustomerOrderProcess

The following process extension(s) is/are available: ReceivedCustomerOrderProcess.Validate
