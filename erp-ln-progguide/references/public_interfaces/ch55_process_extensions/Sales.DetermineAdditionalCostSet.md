...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2232-2232

```baan
Determine customer specific Additional Cost Set that must be used in Sales.
