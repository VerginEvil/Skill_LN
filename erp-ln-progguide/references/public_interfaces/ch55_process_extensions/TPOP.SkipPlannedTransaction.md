...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2308-2309

```baan
Skips Order generation (TPOP) under certain circumstances.
This process extension is available from 2024.05 (KB2331666).
