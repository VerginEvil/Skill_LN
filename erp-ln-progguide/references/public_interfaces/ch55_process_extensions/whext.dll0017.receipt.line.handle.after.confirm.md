# whext.dll0017.receipt.line.handle.after.confirm

> Chapter: Chapter 55 Process Extensions
>
> Group: Process Extensions for ReceiptLine
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 2197-2197

```baan
Syntax: long whext.dll0017.receipt.line.handle.after.confirm(
domain  whinh.shpm       i.receipt,
domain  tcpono           i.receipt.line )
Usage:        Expl:   This function allows to manipulate the receipt line after
confirmation. This process extension is called from the
Infor LN standard, after the confirmation of a receipt line
is executed.
