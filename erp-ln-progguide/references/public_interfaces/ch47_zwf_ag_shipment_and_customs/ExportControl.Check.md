...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1922-1924
...
## Chapter 48 Public Interfaces for Software Utilities

## Public Interfaces for Logger

The following functions are available: Logger.Close Logger.Log Logger.Open
