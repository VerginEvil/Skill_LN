...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1324-1326
...
## Chapter 27 Public Interfaces for Service

## Public Interfaces for Service

The following functions are available: Service.DetermineStartOrFinishTime Service.GetClaimSettings Service.GetGeneralSettings Service.GetMaintenanceSalesOrderSettings Service.GetMobileServiceSettings Service.GetPlanningSettings Service.GetQuoteSettings Service.GetResourceCalendarCode Service.GetServiceOrderSettings Service.GetWorkOrderSettings
