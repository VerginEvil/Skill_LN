...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1824-1826
...
## Chapter 42 Public Interfaces for Product Lifecycle

## Management

## Public Interfaces for PLMObject

The following functions are available: PLMObject.CheckIn PLMObject.CheckOut PLMObject.CreateGenerationBulk PLMObject.FreezeGenerationBulk PLMObject.GenerateKeyNumber PLMObject.SendToIDM PLMObject.SendToIDMForProject PLMObject.SendToIDMForProjectActivity PLMObject.SendToIDMForRevisions PLMObject.UndoCheckIn PLMObject.UndoCheckOut
