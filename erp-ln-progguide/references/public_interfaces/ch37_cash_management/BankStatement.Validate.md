...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 1795-1797
...
## Chapter 38 Public Interfaces for Accounts Payable

## Public Interfaces for AccountsPayable

The following functions are available: AccountsPayable.DetermineDueDate
