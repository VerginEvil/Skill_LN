...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 838-840
...
## Public Interfaces for WorkCell

The following functions are available: WorkCell.RejectProduct WorkCell.ReportProduct WorkCell.SendToInventory
