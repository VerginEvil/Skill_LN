...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 737-738

```baan
DLL:   tiextsfcapi
This function is available from 2024.10 (KB3532922).
Syntax: long ProductionOrder.PrintReceiptNoteV2(
domain  tcsite           iSite,
...
Usage:        Expl:   Function is used to print Production Order Receipt Note
Report.
