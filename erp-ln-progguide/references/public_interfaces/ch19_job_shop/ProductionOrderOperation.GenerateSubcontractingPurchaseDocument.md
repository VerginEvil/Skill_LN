...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 788-789

```baan
DLL:   tiextsfcapi
This function is available from     2023.11 (KB2302527  ).
Syntax: long ProductionOrderOperation.GenerateSubcontractingPurchaseDocument(
domain  tcsite           iSite,
