...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 741-741

```baan
DLL:   tiextsfcapi
This function is available from 2024.10 (KB3532922).
Syntax: long ProductionOrder.PrintRoutingSheetV2(
domain  tcsite           iSite,
domain  tcorno           iProductionOrder,
domain  tcopno           iOperationFrom,
domain  tcopno           iOperationTo,
domain  tcemm.grid       iEnterpriseUnit,
boolean          iIncludeMicroroutingOnRoutingSheet,
...
Usage:        Expl:   Function is used to print Production Order Routing Sheet
Report.
...
iIncludeMicroroutingOnRoutingSheet
Control for including microrouting on
Routing Sheet.
...
information.
Return: 0                       Routing Sheet Printed.
<> 0                    Errors occurred.
```
