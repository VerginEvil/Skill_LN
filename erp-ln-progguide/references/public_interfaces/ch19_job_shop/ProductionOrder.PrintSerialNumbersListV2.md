...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 744-745

```baan
DLL:   tiextsfcapi
This function is available from 2024.10 (KB3532922).
Syntax: long ProductionOrder.PrintSerialNumbersListV2(
domain  tcsite           iSite,
...
Usage:        Expl:   Function is used to print Production Order Serial Numbers List
Report.
...
information.
Return: 0                       Serial Numbers List Printed.
<> 0                    Errors occurred.
```
