...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 727-729

```baan
DLL:   tiextsfcapi
This function is available from 2024.10 (KB3532922).
Syntax: long ProductionOrder.PrintMaterialIssueNoteV2(
domain  tcsite           iSite,
...
boolean          iIncludeInvLevelsOnMatIssueNote,
boolean          iIncludeFixedLocOnMatIssueNote,
boolean          iIncludeStrgCondOnMatIssueNote,
...
Usage:        Expl:   Function is used to print Production Order Material Issue Note
Report.
...
iIncludeInvLevelsOnMatIssueNote
Control for including inventory levels
on Material Issue Note.
iIncludeFixedLocOnMatIssueNote
Control for including fixed location
on Material Issue Note.
iIncludeStrgCondOnMatIssueNote
Control for including storage conditions
on Material Issue Note.
...
information.
Return: 0                       Material Issue Note Printed.
<> 0                    Errors occurred.
```
