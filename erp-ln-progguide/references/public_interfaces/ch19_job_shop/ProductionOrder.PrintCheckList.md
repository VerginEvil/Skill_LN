...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 721-722

```baan
DLL:   tiextsfcapi
This function is available from 2024.04 (KB2305206).
Syntax: long ProductionOrder.PrintCheckList(
domain  tcsite           iSite,
...
boolean          iIncludeFixedLocOnCheckList,
...
Usage:        Expl:   Function is used to print Production Order Check List Report.
...
iIncludeFixedLocOnCheckList
Control for including fixed locations
on Check List.
...
information.
Return: 0                       Operation Note Printed.
<> 0                    Errors occurred.
```
