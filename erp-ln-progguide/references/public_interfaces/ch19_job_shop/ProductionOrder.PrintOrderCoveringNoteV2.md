...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 734-735

```baan
DLL:   tiextsfcapi
This function is available from     2024.10 (KB3532922  ).
Syntax: long ProductionOrder.PrintOrderCoveringNoteV2(
domain  tcsite           iSite,
...
Usage:        Expl:   Function is used to print Production Order Order Covering Note
Report.
...
information.
Return: 0                       Order Covering Note Printed.
<> 0                    Errors occurred.
```
