...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 638-640
...
## Public Interfaces for JobShopBillOfMaterial

The following functions are available: JobShopBillOfMaterial.ApproveRevision JobShopBillOfMaterial.Copy JobShopBillOfMaterial.CreateNewRevision JobShopBillOfMaterial.ExpireRevision JobShopBillOfMaterial.Explode JobShopBillOfMaterial.GetSourceEngineeringRevision JobShopBillOfMaterial.RemoveUseUp JobShopBillOfMaterial.SetUseForCosting JobShopBillOfMaterial.SetUseForPlanning JobShopBillOfMaterial.StartMultiMain JobShopBillOfMaterial.StartOverview JobShopBillOfMaterial.StartPrintWhereUsedComponent JobShopBillOfMaterial.ValidateRevision
