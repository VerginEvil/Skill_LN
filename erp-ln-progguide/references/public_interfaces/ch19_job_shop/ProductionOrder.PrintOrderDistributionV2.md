...
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 736-737

```baan
DLL:   tiextsfcapi
This function is available from     2024.10 (KB3532922  ).
Syntax: long ProductionOrder.PrintOrderDistributionV2(
domain  tcsite           iSite,
...
Usage:        Expl:   Function is used to print Production Order Order Distribution
Report.
...
information.
Return: 0                       Order Distribution Printed.
<> 0                    Errors occurred.
```
