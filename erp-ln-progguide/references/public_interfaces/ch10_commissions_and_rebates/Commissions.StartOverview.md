...
>
> Group: Public Interfaces for Commission
>
> Source: Infor LN Public Interfaces & Process Extensions Reference Guide (Cloud), pp. 388-390

```baan
DLL:   tdextcmsapi
This function is available from     2022.12 (KB2262331  ).
Syntax: long Commissions.StartOverview(
long             iStartMode,
...
Usage:        Expl:   This function starts the session Commissions Overview
(tdcms1550m000).
Input:  iStartMode
...
## Public Interfaces for CommissionAgreement

The following functions are available: CommissionAgreement.StartMultiMain
