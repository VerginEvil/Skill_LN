...
- When this size is reached, the current log file is named "olg.parbshell" and a new empty "log.parbshell" file is created.   The characteristics of the trace mechanism are:
...
- Tracing is enabled by setting the environment variable: TRACEPARBSHELL in the client environment. This variable can be set to the following values
- 0 - no tracing
- 1 - trace API calls
- 2 - trace communication
- 3 - trace API calls and communication    Each trace line is constructed as follows:
