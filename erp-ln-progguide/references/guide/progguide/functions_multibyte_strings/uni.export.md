...
| UNI_MSB_ORDER | Serialize the UTF-16 code units with the most significant byte first, i.e. use UTF-16BE |
| UNI_LSB_ORDER | Serialize the UTF-16 code units with the least significant byte first, i.e. use UTF-16LE |
