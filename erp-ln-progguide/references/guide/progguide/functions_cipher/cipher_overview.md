...
Basically, this is AES (Advanced Encryption Standard) in 128, 192 and 256 bit blocks with various modes such as ECB (Electronic Code Book), CBC (Cipher Block Chaining), CFB (Cipher Feedback) and various others.
