...
## Syntax:
`function void set.bg.color( long wind_id, long color )`

## Description
*Deprecated.* This function is only supported for character-based windows and its usage is therefore deprecated.
This sets the background color of a specified ASCII window. The color argument can have the following values:
| | | | |
|---|---|---|---|
