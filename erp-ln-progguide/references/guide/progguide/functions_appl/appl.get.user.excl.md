...
## Syntax:
`function long appl.get.user.excl( const string name, ref string user(12), [ ref string session(13) ] )`

## Description
This retrieves the LN login name of the user who created the specified exclusive application lock.
