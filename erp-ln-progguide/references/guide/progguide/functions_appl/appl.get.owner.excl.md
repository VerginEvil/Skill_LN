...
## Syntax:
`function long appl.get.owner.excl( const string name, ref long owner, [ ref string session(13) ] )`

## Description
This retrieves the owner of the exclusive application lock.

## Arguments
| | | |
|---|---|---|
| `const string` | `name` |  The name of the exclusive lock.  |
