...
In case a DAL is present, this hook is executed just before the [after.destroy.object()](../functions_dal/after.destroy.object.md) hook.
In case no DAL is present, this hook is executed just before the `main.table.io:after.delete:` UI script section.
In case of a 'stand-alone'[db.delete()](../functions_db_operations/db.delete.md), this hook is executed just after the [db.delete()](../functions_db_operations/db.delete.md) is done.
