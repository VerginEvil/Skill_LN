...
In case a DAL is present, this hook is executed just before the [before.save.object()](../functions_dal/before.save.object.md) hook.
...
In case of a 'stand-alone'[db.update()](../functions_db_operations/db.update.md) or [db.insert()](../functions_db_operations/db.insert.md), this hook is executed before the database operation itself and just before the [ue.after.before.save.object()](ue.after.before.save.object.md) hook.
