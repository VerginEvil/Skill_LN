...
| mark.status |  This is available in the subsections *before.choice* and *after.choice* of *choice.mark.occur*. It indicates the type of marking that the 4GL engine is executing. It can have the following values: DUPL.OCCUR during marking for copying TEXT.MANAGER during marking for edit text 0 in all other cases and when not marking  |
