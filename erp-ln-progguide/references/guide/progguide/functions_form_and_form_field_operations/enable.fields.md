...
- To enable a particular segment of a segmented field, append *.segment.segment_id* to the field name. For example: "tiitm001.item.segment.1".   Because the information is not available, you cannot use this function in the before.program or after.form.read section.
