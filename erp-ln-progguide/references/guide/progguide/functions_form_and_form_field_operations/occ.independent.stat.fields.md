...
## Syntax:
`function long occ.independent.stat.fields( boolean independent.state )`
...
| | | |
|---|---|---|
| `boolean` | `independent.state` |  true, stat fields are occ independent. false, stat fields are dependent on the selection. true is the default  |
