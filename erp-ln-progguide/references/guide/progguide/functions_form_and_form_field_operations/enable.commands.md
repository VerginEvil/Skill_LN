...
## Description
This enables the specified standard and/or form command(s). Standard commands are identified by their Standard commands. Form commands are identified either by a function name, a session code, or a menu code.
...
Notes  The 4GL engine can enable and disable form commands depending on the number of occurrences currently selected in the form.
