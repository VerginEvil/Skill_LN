# Unicode
Unicode is a unification of all (or at least: almost all) currently available character sets. See the Unicode Home Page. In this Programmers Guide, Version 4.0.1 of the Unicode Standard is used, officially referenced as:
...
- Sorting and the Unicode Collation Algorithm (UCA, see UTS #10).
