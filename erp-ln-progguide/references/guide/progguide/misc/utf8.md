...
- each row (containing two groups of four horizontally adjacent boxes) represents a byte.   After these preliminaries, the UTF-8 encoding is defined as follows.
