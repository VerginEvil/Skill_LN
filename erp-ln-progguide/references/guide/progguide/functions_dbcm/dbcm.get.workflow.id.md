...
## Syntax:
`function long dbcm.get.workflow.id( const string toid$, ref string wf.id$ )`

## Description
Retrieves the workflow instance id of the checked-out business object which is identified by the specified Typed Object Id.
...
| `ref string` | `wf.id$` |  The returned workflow instance id as string. In case of an error this parameter is not reset.  |
