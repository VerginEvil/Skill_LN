...
## Description
Reads and makes the business object current, based on the the given typed object id. In case the business object consists of multiple tables, the root table is accessed.
