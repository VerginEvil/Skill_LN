...
## Description
You can use this hook in your UI script to define the conditions under which the field should become readonly in the UI. The 4GL engine uses this hook to determine whether the field must be enabled or made readonly.
...
- In case the field is defined as a [DAL2 Field dependencies](../functions_dal/dal2_field_dependencies.md) of another field and that other field changes.     Notes
...
- The 4GL engine also uses the DAL field hooks in order to determine whether the field must be disabled:
