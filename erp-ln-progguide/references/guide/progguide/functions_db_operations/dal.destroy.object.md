...
- The method.is.allowed(DAL_DESTROY) hook is called

- The before.destroy.object hook is called

- The delete is performed

- The after.destroy.object hook is called
...
- [after.destroy.object()](../functions_dal/after.destroy.object.md)

Notes  This function can be be used for Update Sessions as well as Integrations via OpenWorld. Because it performs more detailed permission checking it is a bit slower than [dal.destroy()](dal.destroy.md). Therefore it is advised to use [dal.destroy()](dal.destroy.md) in case performance is at stake.
