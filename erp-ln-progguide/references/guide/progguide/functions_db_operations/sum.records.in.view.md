...
| | | |
|---|---|---|
| `const string` | `column1.var` |  field or expression to sum specify the field/expression to sum. fieldname or fieldname in expression must exist in the maintable or in the referenced tables. column1.var must be a decimal field.  |
| `double` | `result1.var` |  result of sum fieldname1 specify the output field to receive the sum.  |
