...
| `ref long` | `real_length` |  This returns the length of a row in the table without the internal data. This length is at least the sum of the byte counts of the individual columns. See this list of database types and related byte counts.  |
