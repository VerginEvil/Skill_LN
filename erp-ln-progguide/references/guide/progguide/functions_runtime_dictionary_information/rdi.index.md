...
| `ref long` | `parts(32, 3)` |  This returns the start position, length, and type of the index parts (up to a maximum of 32 parts): parts(i,1) Start position of part *i* in record parts(i,2) Length of part *i*. See this list of database types and related byte counts. parts(i,3) Type of part *i*. See this list of database types.  |
