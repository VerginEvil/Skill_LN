...
## Syntax:
`function long rdi.column( string column_name(17), ref string domain_name(14), ref long offset, ref long size, ref long dept, ref long type, ref long flag, ref string default_value(.) )`
...
| | | |
|---|---|---|
| `string` | `column_name(17)` |  The name of the column about which you want to retrieve information.  |
