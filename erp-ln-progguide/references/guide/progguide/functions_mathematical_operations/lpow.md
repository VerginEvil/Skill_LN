...
When the exact resulting value is outside the signed [BitCountOfLong](../3gl_features/data_types.md#BitCountOfLong)-bit value range, then the result is undefined.
