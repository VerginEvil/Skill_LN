...
- You use the *grab.mwindow()* function to set the process group to which a main window sends its events. After calling this function, all events that occur in the main window are sent to the process group.   See [Processes overview and synopsis](../functions_processes/overview_and_synopsis.md) for details of the functions available for handling processes.
