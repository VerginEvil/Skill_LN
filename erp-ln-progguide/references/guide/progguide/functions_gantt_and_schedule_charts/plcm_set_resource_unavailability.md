...
## Syntax:
`function long plcm.set.resource.unavailability( const string resource.id(), const long no.elements, const long start.date(), const long end.date(), const string description() mb, const string legend.id() mb )`

## Description
Sets the unavailabilities of an resource. This show the bars of unavailabilities on the background of the row of the activity and provide an insight of the availability of the resource.
...
| `const long` | `no.elements` |  Number of unavailabilities of the resource  |
