...
- [Synchronizing processes with the wait() function](synchronizing_processes_with_the_waitfunction.md)  The following diagram provides a schematic overview of the relationships between the scheduler, process queues, and the display server.
