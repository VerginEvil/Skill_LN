...
- TIVLevel >= 2120 and Value of argument quescode starts with "tx"

Notes  The question text and the push button labels are always in the language of the user. The return value of *ask.enum()* is always the enumerate value and not its description. So the script in which the function is used remains language independent.
