...
[Implicit conversion](../3gl_features/type_conversions.md#implicit_type_conversion) of the value of the specified argument from its original type to type double is performed.
