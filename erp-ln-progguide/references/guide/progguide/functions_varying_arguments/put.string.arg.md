...
| `string` | `value` |  The value to assign to the specified argument. [Implicit conversion](../3gl_features/type_conversions.md#implicit_type_conversion) of the supplied string value to the type of the specified argument is performed.  |
