...
## Syntax:
`function long put.double.arg( long arg_no, double value )`

## Description
The function put.double.arg() assigns the supplied double value to the specified argument, after conversion to the type of the argument.
