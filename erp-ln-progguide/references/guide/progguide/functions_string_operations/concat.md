...
| `void` | `value ...` |  Zero or more values of type long, double, or string. Implicit conversion of each value from its original type to type string is performed. The resulting string value is placed in the output string.  |
