...
## Syntax:
`function boolean is.landlord.bse( )`

## Description
This function returns TRUE if the current BSE is a landlord BSE; FALSE otherwise.

## Return values
| | |
|---|---|
| TRUE | The BSE is a landlord BSE. |
| FALSE | The BSE is not multi tenant enabled or is not a landlord BSE. |
