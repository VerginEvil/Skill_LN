...
| `void` | `value` |  The value to be assigned to the variable. [Implicit conversion](../3gl_features/type_conversions.md#implicit_type_conversion) of the supplied value from its original type to the type of the specified variable is performed.  |
