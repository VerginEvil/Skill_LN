...
| `long` | [chart.datapoint.add.tooltipline()](chart.datapoint.add.tooltipline.md) | `( long series, const string pointid, const string tooltip)` |
| `long` | [chart.delete()](chart.delete.md) | `( long chart )` |
| `long` | [chart.line.series.set.curving()](chart.line.series.set.curving.md) | `( long line.series, const string curving)` |
| `long` | [chart.line.series.set.marker()](chart.line.series.set.marker.md) | `( long line.series, const string marker)` |
| `long` | [chart.new()](chart.new.md) | `( long type, [ long width, long height ] )` |
| `long` | [chart.series.add.tooltipline()](chart.series.add.tooltipline.md) | `( const string tooltip )` |
| `long` | [chart.series.set.clickable()](chart.series.set.clickable.md) | `( long series, boolean is.clickable, string seriesname )` |
| `long` | [chart.series.set.color()](chart.series.set.color.md) | `( long series, const string color, long tint)` |
...
| `long` | [chart.set.dual.yaxis()](chart.set.dual.yaxis.md) | `( long chart, long type, const string title)` |
| `long` | [chart.set.legend.position()](chart.set.legend.position.md) | `( long chart, const string legendpos)` |
