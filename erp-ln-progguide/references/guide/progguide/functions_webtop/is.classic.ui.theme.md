...
## Syntax:
`function boolean is.classic.ui.theme( )`

## Description
This function returns true if the UI is running in the classic theme.

## Return values
true UI is running in classic theme.
false UI is not running in classic theme.
