...
- Corrupt TSS multibyte sequence: lead-byte value 0x9B followed by less than three non-0 trail bytes.     Availability  On BaanIVc this function is available from TIV 262. On Infor Enterprise Server it is available from TIV 1620.

## Related topics
- Related operations: [Verify the used characters](contains_valid_characters_only.md)
