...
## Syntax:
`function long xmlGetAttributeQualifiedNameLength( long node, long attributeNr )`

## Description
Get the length of the qualified name of an attribute of the specified node.
...
long length
length = xmlGetAttributeQualifiedNameLength( xml_envelope, 1 )
