...
## Syntax:
`function long xmlDuplicateAndAdd( long destinationNode, long fromNode, [ long toNode ] )`

## Description
Duplicate a tree or a list of trees and add this list to an existing list after the node referred to by *destinationNode*.
