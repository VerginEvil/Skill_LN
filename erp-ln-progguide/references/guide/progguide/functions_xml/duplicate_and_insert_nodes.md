...
## Syntax:
`function long xmlDuplicateAndInsert( long destinationNode, long fromNode, [ long toNode ] )`

## Description
Duplicate a tree or a list of trees and insert this list in an existing list before the node referred to by *destinationNode*.
