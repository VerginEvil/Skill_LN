...
## Syntax:
`function long xmlDuplicateAndInsertInChilds( long parentNode, long fromNode, [ long toNode ] )`

## Description
Duplicate a tree or a list of trees and insert this list as the first child of the node referred to by *parentNode*.
