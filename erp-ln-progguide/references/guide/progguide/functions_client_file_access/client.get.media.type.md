...
## Return values
string representing the MIME Media type of the file. The official list can be found here: [https://www.iana.org/assignments/media-types/media-types.xhtml](https://www.iana.org/assignments/media-types/media-types.xhtml).
