...
## Syntax:
`#include <bic_desktop>`
`function void client.delete.upload.file.object( long id )`

## Description
Delete the result object returned by [client.upload.files](client.upload.files.md). This function is only supported for LN UI.
