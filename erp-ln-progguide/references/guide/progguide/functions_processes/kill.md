...
- TIVLevel >= 2120 and The process to kill should be a not trusted process    Notes  Do not confuse this function with the *kill* command of the operating system. You can use *kill()* to kill process within the same bshell only. You cannot use it to kill the processes of other users.
