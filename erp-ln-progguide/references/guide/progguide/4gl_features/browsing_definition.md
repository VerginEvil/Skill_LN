...
- The browse list displays a list of objects or properties of objects. Only those objects or properties of objects are displayed that are valid within the context of the related input field(s) (browse filter).

Analyzing this definition gives the following:
