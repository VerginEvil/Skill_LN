...
- DIGEST_SHA3_256
- DIGEST_SHA3_384
- DIGEST_SHA3_512  Note: the older DIGEST_SHA algorithm (also known as SHA-0) has been removed from the bshell version 9.1c, TIV 2140, as versions of OpenSSL starting with 1.1.0c do not support the SHA digest anymore. The SHA-0 algorithm has been considered insecure ever since 1995.
