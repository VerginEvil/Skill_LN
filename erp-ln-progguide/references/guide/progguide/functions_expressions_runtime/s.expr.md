...
## Syntax:
`function string s.expr$( long expr_id, [ void value, boolean suppressError ] )`

## Description
Executes (or evaluates) an expression previously compiled by [expr.compile()](expr.compile.md). The result is always converted to a string.
