...
See [UUID Internet Draft Standard](https://tools.ietf.org/html/draft-leach-uuids-guids-01) for a (draft) description of the standard and for further references.
