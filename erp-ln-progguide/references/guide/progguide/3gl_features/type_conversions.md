...
## Long to string type conversion
Explicit long to string type conversion is performed or may be performed during the execution of the following functions.
...
Implicit long to string type conversion may occur during the execution of the following functions. The list may be incomplete.
| | |
|---|---|
| Function | Remark |
...
## String to long type conversion
Explicit string to long type conversion is performed during the execution of the following functions.
| | |
|---|---|
| Function | Remark |
...
Implicit string to long type conversion may occur during the execution of the following functions. The list may be incomplete.
| | |
|---|---|
| Function | Remark |
...
If the exact numerical value is greater than the maximum value 2^( BitCountOfLong-1) - 1 of the signed BitCountOfLong-bit range, then that maximum value is used.
If the exact numerical value is less than the minimum value -2^( BitCountOfLong-1) of the signed BitCountOfLong-bit range, then that minimum value is used.

## Long to double type conversion
There are no functions available for explicit long to double type conversion.
Implicit long to double type conversion may occur during the execution of the following operators and functions. The list may be incomplete.
| | |
|---|---|
| Function | Remark |
| [Assignment operator](assignment_operator.md) | when assigning a long value to a variable of type double |
| [Binary arithmetic operator](arithmetic_operators.md) | when one operand is of type long and the other of type double, the long operand is converted to double  |
| [Relational operator](relational_operators.md) | when one operand is of type long and the other of type double, the long operand is converted to double  |
...
When long to double type conversion occurs, the intention is that the resulting double value has the same numerical value as the original long value.
...
## Double to long type conversion
Explicit double to long type conversion is performed during the execution of the following functions.
| |
|---|
| Function |
| [int()](../functions_mathematical_operations/int.md) |
Implicit double to long type conversion may occur during the execution of the following operators and functions. The list may be incomplete.
| | |
|---|---|
| Function | Remark |
| [Assignment operator =](assignment_operator.md) | when assigning a double value to a variable of type long |
...
When (explicit or implicit) double to long type conversion occurs, the intention is that the resulting long value is a good approximation of the original double value.
