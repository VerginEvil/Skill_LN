...
## Syntax:
`function void disable.db.dll( )`

## Description
This disables the call of the db hooks in the db dll. (db.before.insert, db.before.update, db.before.delete, db.after.insert, db.after.update, db.after.delete)
