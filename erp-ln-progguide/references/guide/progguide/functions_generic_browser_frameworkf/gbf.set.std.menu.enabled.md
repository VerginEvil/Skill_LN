...
## Syntax:
`function long gbf.set.std.menu.enabled( )`
...
This function can enable standard GBF menu headings and/or menu items, which has been created using the [gbf.init()](gbf.init.md) function.
