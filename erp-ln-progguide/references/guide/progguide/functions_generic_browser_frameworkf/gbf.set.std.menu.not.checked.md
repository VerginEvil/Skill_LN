...
## Syntax:
`function long gbf.set.std.menu.not.checked( )`
...
This function can remove a ticmark on a menu item, which has been created using the [gbf.init()](gbf.init.md) function.
