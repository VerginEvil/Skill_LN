...
## Syntax:
`function long gbf.set.std.menu.disabled( )`
...
This function can disable standard GBF menu headings and/or menu items, which has been created using the [gbf.init()](gbf.init.md) function.
