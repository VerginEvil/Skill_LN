...
## Syntax:
`function long gbf.add.leaf( const string object.key(), string object.description() mb, long object.value )`

## Description
Adds a leaf node to the object tree.
Same as: gbf.add.object(key, desc, value, GBF.LEAF)
