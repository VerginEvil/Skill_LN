...
## Description
These functions set the open or close strategy, which is what the GBF should do when an interior node is closed and opened again as well as what should be done on the Open All menu item.
...
GBF.OPEN.AGAIN + GBF.OPEN.NOREAD + GBF.OPEN.CURSEL.
