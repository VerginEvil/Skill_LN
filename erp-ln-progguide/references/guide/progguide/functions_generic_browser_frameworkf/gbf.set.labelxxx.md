...
- when another object becomes selected the key of the selected object will be displayed in label2   The others are only set in [gbf.init()](gbf.init.md) and left unchanged by the GBF, hence an overwrite using this gbf.set.label() will be permanent.
