...
## Syntax:
`function long gbf.add.header( const string object.key(), string object.description() mb, long object.value )`

## Description
Adds a header to the object tree.
Same as: gbf.add.object(key, desc, value, GBF.HEADER)
