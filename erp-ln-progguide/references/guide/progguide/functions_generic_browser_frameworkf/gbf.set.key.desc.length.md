...
| | | |
|---|---|---|
| `long` | `key.length` |  The new key length. If 0 nothing happens.  |
| `long` | `desc.length` |  The new description length. If 0 nothing happens.  |
