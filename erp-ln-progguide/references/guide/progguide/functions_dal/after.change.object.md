...
It is called by the 4GL engine at the moment the end-user presses the Save button for a modified record. It is also executed when a [dal.save.object()](../functions_db_operations/dal.save.object.md) is done. In both cases it is executed before any validations are performed.
