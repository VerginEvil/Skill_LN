...
| HOOK_IS_VALID | <field>.is.valid() <field>. *constant*.is.applicable() |
...
- dal.field.depends.on("B", HOOK_UPDATE, "A")

This function can only be called in the [before.open.object.set()](before.open.object.set.md) hook!
