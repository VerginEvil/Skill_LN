...
- [query.extend.where.in.zoom()](../functions_sql_query_extensions/query.extend.where.in.zoom.md)  You can program query extensions in the UI script and/or the DAL script. In the UI script, you program the extensions in the *before.program* or *before.zoom* sections. In the DAL script, you program the extensions in the [before.open.object.set()](before.open.object.set.md) hook.
