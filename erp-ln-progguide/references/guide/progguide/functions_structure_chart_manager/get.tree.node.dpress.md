...
## Syntax:
`function void get.tree.node.dpress( ref long event, ref long process_id, ref string node_id )`
...
| | | |
|---|---|---|
| `ref long` | `event` |  The event containing the MSG.NODE.DPRESS command.  |
