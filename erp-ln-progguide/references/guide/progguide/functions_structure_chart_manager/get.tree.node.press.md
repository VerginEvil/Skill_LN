...
## Syntax:
`function void get.tree.node.press( ref long event, ref long process_id, ref string node_id )`

## Description
*Deprecated.* This function is only supported for Baan Windows and its usage is therefore deprecated.
Use this function to retrieve data from the Structure Chart Manager after an EVTBUCKETMESSAGE-type event, with a MSG.NODE.PRESS command, has been received.

## Arguments
| | | |
|---|---|---|
| `ref long` | `event` |  The event containing the MSG.NODE.PRESS command.  |
