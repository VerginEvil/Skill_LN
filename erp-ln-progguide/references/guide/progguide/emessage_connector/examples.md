...
|******************************************************************************
|tables
table   tttadv002       | Infor Enterprise Server Parameters
...
## How to use the Infor LN eMessage Connector API to construct and send an meeting request over SMTP
In this example function cmf.send is used how to send an iCalendar meeting request over SMTP.
```
