...
- Use the bic6.2 compiler. For example: `$ bic6.2 dll1 -o odll1 $ bic6.2 dll2 -o odll2 $ bic6.2 dll3 -o odll3 $ bic6.2 <program> -o<object> -d odll1:odll2:odll3`  Note that, at runtime, external functions are searched for in the order in which the DLLs were supplied during compilation. In above example, dll1 is first.
