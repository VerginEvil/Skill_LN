...
| `ref string` | `str` |  The string to write the JSON text to; this string should be large enough to contain the complete JSON text; in case it is hard to tell the size upfront, it is advised to use function Json.write() instead.  |
