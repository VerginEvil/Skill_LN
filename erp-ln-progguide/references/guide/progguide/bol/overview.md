...
- It has a set of actions, Business Object Methods, which can manipulate the Business Object Attributes (i.e. Create Purchase Order, List Organizational Units)   In order to model and store all this information the Business Object Repository is developed.
