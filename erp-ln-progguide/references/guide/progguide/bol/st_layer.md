...
- example without component: gaadv.bl091st00.get.payByBP()

'Setter' functions looks like:

- <dll name>.set.<component name>.<attribute>(value)

- example: gaadv.bl090st00.set.Header.customerReference(value)

- example without component: gaadv.bl091st00.set.payByBP(value)

Functions to detect whether an attribute have been set looks like:

- <dll name>.is.set.<component name>.<attribute>()

- example: gaadv.bl090st00.is.set.Header.payByBP()

- example without component: gaadv.bl091st00.is.set.payByBP()

Also within the Protected Layer a function is present to get the result of a method.
