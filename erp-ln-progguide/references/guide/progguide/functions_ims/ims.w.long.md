...
## Related topics
- Related operations: [ims.w.short()](ims.w.short.md)
- Inverse operations: [ims.r.long()](ims.r.long.md), [ims.r.short()](ims.r.short.md)
- Special operations for UTC long format values: [ims.r.utc()](ims.r.utc.md), [ims.w.utc()](ims.w.utc.md)
