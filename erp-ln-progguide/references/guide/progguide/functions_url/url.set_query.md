...
## Syntax:
`#include <bic_web>`
`function void url.set_query( long url_instance, const string query )`

## Description
Sets the query of a URL instance.
...
| `const string` | `query` |  A query string, like `"a=3&w=true&q='hi there!'"`.  |
