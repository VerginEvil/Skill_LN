...
## Syntax:
`#include <bic_web>`
`function void query_params.add( long query_params_instance, const string name, const string value )`

## Description
Adds a query parameter to a query_params instance. If the parameter already exists, the value is added to the already existing ones.
