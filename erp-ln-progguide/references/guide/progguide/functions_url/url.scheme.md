...
## Syntax:
`#include <bic_web>`
`function string url.scheme( long url_instance )`

## Description
Returns the scheme of a URL instance. This is an empty string if the URL instance does not specify a scheme.
