...
## Syntax:
`function void change.sub.object( long object, long sub_object_id, long attribute, void value, long size )`

## Description
*Deprecated.* This function is only supported for Baan Windows and its usage is therefore deprecated.
This changes the attribute values of the specified subobject.
