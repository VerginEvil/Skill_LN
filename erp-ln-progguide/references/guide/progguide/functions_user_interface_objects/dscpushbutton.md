...
| DsNshowAsDefault (long) | [CSG] | Indicates whether the button is the default button. If TRUE, the button has a thicker border and can be activated with the <Enter> key. |
