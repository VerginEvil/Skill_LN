...
| | | |
|---|---|---|
| `[ void` | `exitvalue ]` |  Exit value to be returned to the calling program. [Implicit conversion](../3gl_features/type_conversions.md#implicit_type_conversion) of the supplied value from its original type to the string type is performed.  |
