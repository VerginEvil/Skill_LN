...
## Syntax:
`function long chm.delete.data( )`

## Description
*Deprecated.* This function is only supported for Baan Windows and its usage is therefore deprecated.
This removes from memory the data points added by [chm.data.in()](chm.data.in.md). The function cannot delete data points that the application has already saved.
