...
## Syntax:
`function long chm.first.data2domain.out( ref double series_value )`

## Description
*Deprecated.* This function is only supported for Baan Windows and its usage is therefore deprecated.
Use this to check which is the first graph series that is linked to the second data domain of the current chart.
