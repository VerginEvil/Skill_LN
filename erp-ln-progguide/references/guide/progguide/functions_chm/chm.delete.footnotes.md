...
## Syntax:
`function long chm.delete.footnotes( )`

## Description
*Deprecated.* This function is only supported for Baan Windows and its usage is therefore deprecated.
This removes from memory the footnotes added by [chm.footnote.in()](chm.footnote.in.md). The function cannot delete values that the application has already saved.
