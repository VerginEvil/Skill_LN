...
- upper margin – that is, the number of time units by which the end time of the activity may be exceeded

You must create a PCM_OT_ACTIVITY object for each activity you want to include in the chart.
