...
## Usage notes
*Note:* It is advised to keep *<index>* in the safe range from 1 to the length of the string. If *<index>* is outside this range, the behavior is implementation defined.
