...
The concept of UTC (Universal Coordinated Time) is further described in the overview of bshell functions for dates, times and time zones in the Infor ES Programmers Guide.
...
## Correspondence of SQL data types with Infor Enterprise Server database data types
The following table shows which Infor Enterprise Server database type corresponds with a certain SQL type:
| | |
|---|---|
| SQL type | Infor Enterprise Server Database type |
...
```
The term BitCountOfUtc is further described in the overview of bshell functions for dates, times and time zones in the Infor ES Programmers Guide.
...
The term ByteCountOfUtc is further described in the overview of bshell functions for dates, times and time zones in the Infor ES Programmers Guide.
...
The term Utc32 mode is further described in the overview of bshell functions for dates, times and time zones in the Infor ES Programmers Guide.
...
The term Utc40 mode is further described in the overview of bshell functions for dates, times and time zones in the Infor ES Programmers Guide.
...
The term Utc64 mode is further described in the overview of bshell functions for dates, times and time zones in the Infor ES Programmers Guide.
