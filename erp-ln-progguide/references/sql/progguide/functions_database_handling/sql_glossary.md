...
Degree   The degree of a table is the number of columns that table has. In this an array column counts as 1 column. The company_nr column also counts as a column.
